...
import {fetchAsynchomegame } from '../../Redux/homeSlice';
import { getHomegame } from '../../Redux/homeSlice';
...
function Categorygaming() {
  const { t, i18n } = useTranslation();
    ...
    useEffect(() => {
     dispatch(fetchAsynchomegame(country))
    }, [country])
    const homegame=useSelector(getHomegame)
